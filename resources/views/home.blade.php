...
==================================== -->
 ...
 <section class="hero-area overlay" style="background-image: url('images/banner/bannergedung.jpg');">
 	...
 	<div class="block">
        ...
        <h2><span class="color">Pabrik Gula Candi Baru</span> </h2>
 		<p>Pabrik Gula dengan upaya terus meningkatkan kualitas dan kuantitas terbaik di tengah Masyarakat modern. </p>
 		<a href="#portal" class="btn btn-transparent smooth-scroll">Menuju Portal</a>
 	</div>
 </section>
  ...
  <div class="navbar-header w-100">
    <nav class="navbar navbar-expand-lg navbar-dark px-0">
      ...
      <a class="navbar-brand logo" href="index.html">
        ...
        <img src="images/logopgcandibaru.png" class="img-fluid" alt="logo" style="width: 50px; height: auto;">
      </a>
      <!-- /logo -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms">
				<div class="block">
					<div class="icon-box" style="margin-bottom: 0px;">
						<img src="images/about/gula.jpg" alt="tebu2" class="img-fluid">
					</div>
					<!-- Express About Yourself -->
					<div class="content text-center" style="padding: 20px;">
						<h3 class="ddd">Produk Unggulan</h3>
						<p>Kami menghadirkan gula berkualitas premium yang terbuat dari tebu pilihan, diproses dengan teknologi modern. Gula kami memiliki rasa alami dan kemurnian tinggi, ideal untuk segala kebutuhan</p>
					</div>
				</div>
			</div>
			<!-- End About item -->
			...
			<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="250ms">
				<div class="block">
					<div class="icon-box" style="margin-bottom: 0px;">
						<img src="images/about/tebu2.jpg" alt="tebu2" class="img-fluid">
					</div>
					<!-- Express About Yourself -->
					<div class="content text-center" style="padding: 20px;">
						<h3>Kualitas Terbaik</h3>
						<p>Gula kami diproduksi dengan standar kualitas tertinggi, menggunakan tebu pilihan dan proses modern. Setiap tahap produksi diawasi ketat untuk memastikan kemurnian, kebersihan, dan rasa optimal.</p>
					</div>
				</div>
			</div>
			<!-- End About item -->
			...
			<div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="500ms">
				<div class="block kill-margin-bottom">
					<div class="icon-box" style="margin-bottom: 0px;">
						<img src="images/about/jempol.jpg" alt="amazing caves coverimage" class="img-fluid">
					</div>
					<!-- Express About Yourself -->
					<div class="content text-center" style="padding: 20px;">
						<h3>Tersertifikasi dan Teruji</h3>
						<p>Produk gula kami telah melalui serangkaian uji kualitas yang ketat dan mendapatkan sertifikasi dari lembaga terpercaya. Standar produksi kami mengikuti pedoman internasional.</p>
					</div>
				</div>
			</div>
			<!-- End About item -->
...
<section class="section about-2 padding-0 backgroundT" id="about">
	<div class="container-fluid p-0">
		<div class="row no-gutters align-items-center">
			<div class="col-lg-6">
				<img class="img-fluid" src="images/about/aboutimage.jpg" alt="" style="width: 100%; height: 63vh; object-fit: cover;">
			...
			<div class="col-lg-6">
				<div class="content-block">
					...
					<br/>
					<p style="font-size:1.17em">Pabrik Gula dengan upaya terus meningkatkan kualitas dan kuantitas terbaik di tengah Masyarakat modern. </p>
					<div class="row">
						<div class="col-md-6">
							<div class="media">
								<div class="pull-left">
								...
								<div class="media-body">
									...
									<p>Program kemitraan antara petani dengan PG Candi Baru dengan memberi kemudahan pada petani untuk menghasilkan terbaik.</p>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="media">
								...
								<div class="media-body">
									...
									<p>Dengan memanfaatkan aplikasi teknologi canggih, petani kini dapat mengelola semua kegiatan terkait pertanian dan panen dengan lebih efisien.
									</p>
								</div>
							</div>
						</div>
...
<section id="portal" class="portal section section-bg">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<!-- section title -->
			...
			<div class="col-lg-12">
				...
				<div class="copyright text-center">
					<a href="">
						...
						<img src="images/logopgcandibaru.png" class="img-fluid" alt="logo"width="60px" height="auto">
